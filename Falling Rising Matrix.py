...
video=cv2.VideoWriter('Falling Rising Matrix.mp4',FourCC,30,(1920,1080))
...
while T<=n:
	...
	for i in range(1,len(PROPERTIES)):
		...
		if x%2==0:
			...
			y=(y-10*T)%1080
		cv2.putText(Frame,PROPERTIES[i][0],(x,y),PROPERTIES[i][2],PROPERTIES[i][3],PROPERTIES[i][4],PROPERTIES[i][5])
	video.write(Frame)
